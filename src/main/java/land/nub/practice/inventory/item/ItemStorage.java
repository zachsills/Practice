...
public class ItemStorage {
    ...
    public static ItemStack LOBBY_COSMETICS = new I(Material.DIAMOND).name(C.color("&6Cosmetics")).lore(C.color("&7View and change your cosmetic."));
    ...
    public static ItemStack PARTY_RANKED_DUOS = new I(LOBBY_RANKED).name(C.color("&e2v2 Ranked Queue")).clearLore().lore(C.color("&7Queue for a 2v2 Ranked match."));
    public static ItemStack PARTY_UNRANKED_DUOS = new I(LOBBY_UNRANKED).name(C.color("&e2v2 Unranked Queue")).clearLore().lore(C.color("&7Queue for a 2v2 Unranked match."));
